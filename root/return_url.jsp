...
<%
	...
	System.out.println(" 返回支付宝     return_url.jsp  out_trade_no   "+out_trade_no+"   trade_no  "+trade_no+"  trade_status  "+trade_status);
	//计算得出通知验证结果
	...
	if(verify_result){//验证成功
		...
		//该页面可做页面美工编辑
		out.println("<h2><br /><br /><br /><br />订单号："+out_trade_no+"<br><br>支付成功<br /><br /></h2>");
		//——请根据您的业务逻辑来编写程序（以上代码仅作参考）——

		//////////////////////////////////////////////////////////////////////////////////////////
	}else{
		//该页面可做页面美工编辑
		out.println("<h2>验证失败</h2>");
	}
%>


<br><br><br>请关注公众号<名卡联盟>后开启名卡生活之旅，祝您愉快！<br /><br /><img src='http://www.mycard.top/h5-js/html5/qrcode_for_mk.jpg'><br>长按二维码关注【名卡联盟】<br><br>
<br><br><br>
<div class="copyright">
