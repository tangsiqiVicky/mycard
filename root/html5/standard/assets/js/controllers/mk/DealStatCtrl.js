...
//app.controller('DealStatCtrl', ["$window", "$scope", "$location", "$rootScope", '$localStorage', '$state', function ($window, $scope, $location, $rootScope, $localStorage, $state) {
app.controller('DealStatCtrl', ["$window", "$scope", "$location", "$rootScope", '$localStorage', '$state', "ngTableParams", "SweetAlert", function ($window, $scope, $location, $rootScope, $localStorage, $state, ngTableParams, SweetAlert) {


    $rootScope.currTitle = "交易统计";
