...
var date = function ($) {
    ...
    $.fn.hotelDate = function (options) {
        ...
        function initTemplate() {
            ...
            // 主容器模板
            var dateTemplate =
                '\n        <div class =\'date container c-gray\' style="padding-top:15px ">\n        ' +
                '  <div style="position:fixed;top:0;background:#3e93fa;width: 100%;margin-left:-15px;" > <div class=\'close-btn\' style="color: white;line-height: 30px">\u786E\u5B9A</div><div class="tac bold text-white" style="line-height: 30px;text-align: center"  >\u8BF7\u9009\u62E9\u65F6\u95F4</div></div>\n      ' +
                '   \n        </div>      \n      ';
