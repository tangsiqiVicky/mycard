...
app.controller('InChargeCtrl', ["$window", "$scope", "$rootScope", "ngTableParams", "$location", function ($window, $scope, $rootScope, ngTableParams, $location) {


    $rootScope.currTitle = "储值管理";
    ...
    $scope.showdetail = function (shop_id) {

        $rootScope.arg0 = shop_id;
        $location.path("/app/wx/me/incharge_detail");
    }


    $scope.showxfdetail = function (shop_id) {

        $rootScope.arg0 = shop_id;
        $location.path("/app/wx/me/incharge_xf_detail");
    }
