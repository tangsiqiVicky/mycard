...
<html>
	...
	<%
		...
		System.out.println("alipayapi.jsp  show_url "+show_url);
        //商品描述，可空
        String body = new String(request.getParameter("WIDbody").getBytes("ISO-8859-1"),"UTF-8");

		String userId = new String(request.getParameter("WIDuserId").getBytes("ISO-8859-1"),"UTF-8");
		...
		sParaTemp.put("extra_common_param", userId+"~~X"+total_fee);

		
		//其他业务参数根据在线开发文档，添加参数.文档地址:https://doc.open.alipay.com/doc2/detail.htm?spm=a219a.7629140.0.0.2Z6TSk&treeId=60&articleId=103693&docType=1
        //如sParaTemp.put("参数名","参数值");

		//System.out.println("alipayapi.jsp  sParaTemp   "+sParaTemp);
		//建立请求
		String sHtmlText = AlipaySubmit.buildRequest(sParaTemp,"get","确认");
		//System.out.println(sHtmlText);
		//System.out.println("alipayapi.jsp  sHtmlText   "+sHtmlText);
